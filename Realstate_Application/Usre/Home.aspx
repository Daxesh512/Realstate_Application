<%@ Page Title="Home" Language="C#" MasterPageFile="~/Usre/users.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="Realstate_Application.Usre.WebForm1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    
    <center>
         <h1>Welcome to RealStar </h1>
    </center>
